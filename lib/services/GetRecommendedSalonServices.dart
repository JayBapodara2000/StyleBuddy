...
class GetRecommendedSalonServices {
  static Future<GetRecommendedSalonModel?> getRecommendedSalonService(
      String url, Object body) async {
    GetRecommendedSalonModel? result;
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        result = GetRecommendedSalonModel.fromJson(item);
        Loader.hide();
      } else {
